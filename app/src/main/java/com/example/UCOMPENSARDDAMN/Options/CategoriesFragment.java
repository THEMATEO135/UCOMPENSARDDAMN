package com.example.UCOMPENSARDDAMN.Options;
...
import com.example.UCOMPENSARDDAMN.databinding.FragmentCategoriesBinding;
...
//Si hemos abierto correctamente la base de datos
        if (db != null) {
            ...
            if (c.moveToFirst()) {
                ...
                TableLayout tl= root.findViewById(R.id.tabla);
